...
namespace TSV
{
    public partial class frmTSVFile : Form
    {
        ...
        private void tsmiOpen_Click_1(object sender, EventArgs e)
        {
        ...
        private void frmTSVFile_Load_1(object sender, EventArgs e)
        {
            tsslMessage.Text = "請開啟檔案";
        }

        private void frmTSVFile_FormClosing_1(object sender, FormClosingEventArgs e)
        {
